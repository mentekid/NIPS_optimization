...
\begin{itemize}
  \item {\bf SGD variants:} Vanilla SGD, SCD, SGDR, SMORMS3, AdaGrad, AdaDelta, RMSProp, Adam, AdaMax
  \item {\bf Quasi-Newton variants:} LBFGS, IQN, AugLagrangian
  \item {\bf Genetic variants:} CNE, CMA-ES
  \item {\bf Simulated Annealing}: Vanilla SA
